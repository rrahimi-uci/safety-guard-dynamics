...
which \Cref{sec:actI}'s question is posed: they normalize the single-suite comparison whose fragility
...
specialization} specifically (represented cost small, transfer recovered relative to SFT; the aggregate
edge over the \emph{base} is nominally positive but sits inside the reproduction envelope of
\Cref{sec:actI-klsft} and is unresolved --- \Cref{tab:pilot-summary,tab:pilot-models}), and we are
explicit about what the pilot does
