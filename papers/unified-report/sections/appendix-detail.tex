...
decontamination, a family-isolated train/dev/test split plus a committed 95-row confirmatory slice that is
\emph{not} sealed (\Cref{sec:actIV}), and are published
