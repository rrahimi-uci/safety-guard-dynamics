...
plus a 95-row confirmatory slice; ``family-isolated'' means near-duplicate rows are grouped and sent as
a whole to \emph{either} train or test, never split, so a guard cannot ace the test by having seen a
