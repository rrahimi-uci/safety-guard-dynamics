...
\input{../unified-report/generated/results_macros_gen}   % \Rep*, \Transfer*, \HarmBench*, \ORBench*
\input{../unified-report/generated/matched_fpr_macros}   % \Matched*
\input{../unified-report/generated/lowfpr_macros}        % \LowFpr*
\input{../unified-report/generated/lowfpr_kl_macros}     % \LowFprKl*
\input{../unified-report/generated/klsft_macros}         % \KL*
\input{../unified-report/generated/adaptation_macros}    % \Ada*
\input{../unified-report/generated/frontier_macros}      % \Frontier*
\input{../unified-report/generated/h2h_macros}           % \Htwo*
\input{../unified-report/generated/pilot_macros}         % \Pilot*
\input{../unified-report/generated/mortgage_composition_macros} % \Mort*
\input{../unified-report/generated/repro_macros}         % \Repro*
...
\paragraph{C2: separate represented from source-held-out.}\leavevmode\newline Every guard and its base are scored in two
...
re-thresholded so its pooled false-alarm rate on the evaluated negatives is \emph{at or below its own base's}.
Only the second licenses a sentence about catching more or less. One limit travels with every such
number: the budget and matched threshold are determined on the \emph{evaluated} negatives and recall measured on
...
\label{tab:primary}
\resizebox{\linewidth}{!}{\input{../unified-report/generated/tab_primary_gen}}
\end{table}
...
pooled transfer false-alarm rate is at or below its own base's. The apparent gain does not merely shrink --- it
...
tuned guard catches \emph{less than half} of what its own untuned base catches off-source.
...
\paragraph{On unfamiliar traffic the hosted model is clearly better.}\leavevmode\newline On \citet{expguard2026}'s external,
...
request only. Finally, every matched-budget number selects its threshold from the labelled
...
OpenAI Codex was used in preparing this manuscript in two bounded roles, and in no role that produced
substantive text. First, it assisted with analysis and plotting code, all of which is committed and whose
outputs are byte-checked against committed per-row scores. Second, it assisted with copy-editing of
author-written prose (grammar, concision, and consistency of terminology). No section, argument, claim,
or number was generated by a model. All numerical values in this paper are emitted by
...
\paragraph{Guard models and their evaluation.}\leavevmode\newline Purpose-built guards
\citep{inan2023llamaguard,han2024wildguard,zeng2024shieldgemma,padhi2024graniteguardian,qwen3guard2025}
...
\paragraph{Checkpoints and adapters.}\leavevmode\newline Four open instruction checkpoints (Qwen2.5-1.5B, SmolLM2-1.7B,
...
Every matched-budget figure in this paper sets a base-model alarm budget and selects its matched threshold
from the observed scores of the \emph{evaluated} negatives, then measures recall on the same rows. This is a standard way to read a
...
\resizebox{\linewidth}{!}{\input{../unified-report/generated/tab_sensitivity_gen}}
\end{table}

\input{../unified-report/generated/tab_matched_fpr_gen}

\input{../unified-report/generated/tab_lowfpr_gen}

\input{../unified-report/generated/mortgage_baseline_table}

\input{../unified-report/generated/mortgage_composition_table}
